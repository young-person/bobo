...
public class WeatherRecordTask implements CrawlerDown {
	...
	public void initCityUrls() throws UnsupportedEncodingException {
        
        
		String content = request.doGet(Linking.WEATHERURL.getUrl());
	...
	public void paramHtml(String mc, String href) throws UnsupportedEncodingException{
		String html = request.doGet(href);//访问详情页面
