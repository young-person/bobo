...
//            executor.shutdown();
     ...
     */
    private void parseContentData(List<HistoryBean> datas, List<RicheBean> list, RicheResult handResult) throws IOException, URISyntaxException {
    ...
    private void insertDataByExcel(RicheBean bean, List<HistoryBean> datas) {
        ...
        try {
            if (Objects.nonNull(datas) && datas.size() > 0) {
                ...
                String time = preDayRow.getCell(0).getStringCellValue();
                ...
                if (datas.size() > 0) {
                    ...
                    if (v1.equals(b.getHand())
                            && v2.equals(b.getRisePrice())
                            && v3.equals(b.getOpenPrice())
                            && v4.equals(b.getClosePrice())
                            && v6.equals(b.getMaxPrice())
                            && v7.equals(b.getMinPrice())
                            && v8.equals(b.getTotal())
                            && v9.equals(b.getMoney())) {
                        return;
                    }
                }
