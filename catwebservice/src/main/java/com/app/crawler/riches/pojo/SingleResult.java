...
public class SingleResult implements Serializable{
	 ...
	 * @data 2019年11月1日 下午11:17:36 
	 */ 
	private static final long serialVersionUID = -8015120819150311489L;
	/**
	 * 股票代码
	 */
	private String code;
	...
	public String toString() {
		return "SingleResult [code=" + code + ", codeType=" + codeType + ", stockName=" + stockName + ", newPrice="
				+ newPrice + ", risePrice=" + risePrice + ", prevClose=" + prevClose + ", open=" + open + ", maxPrice="
				+ maxPrice + ", minPrice=" + minPrice + ", totalHand=" + totalHand + ", sellPrice5=" + sellPrice5
				+ ", sellPrice4=" + sellPrice4 + ", sellPrice3=" + sellPrice3 + ", sellPrice2=" + sellPrice2
				+ ", sellPrice1=" + sellPrice1 + ", sellCount5=" + sellCount5 + ", sellCount4=" + sellCount4
				+ ", sellCount3=" + sellCount3 + ", sellCount2=" + sellCount2 + ", sellCount1=" + sellCount1
				+ ", buyPrice1=" + buyPrice1 + ", buyPrice2=" + buyPrice2 + ", buyPrice3=" + buyPrice3 + ", buyPrice4="
				+ buyPrice4 + ", buyPrice5=" + buyPrice5 + ", buyCount1=" + buyCount1 + ", buyCount2=" + buyCount2
				+ ", buyCount3=" + buyCount3 + ", buyCount4=" + buyCount4 + ", buyCount5=" + buyCount5 + ", upPrice="
				+ upPrice + ", downPrice=" + downPrice + ", weiBi=" + weiBi + ", weiCha=" + weiCha + ", inside="
				+ inside + ", outside=" + outside + ", swing=" + swing + ", totalAmount=" + totalAmount + "]";
	}
