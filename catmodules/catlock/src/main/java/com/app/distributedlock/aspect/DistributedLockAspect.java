package com.app.distributedlock.aspect;

import com.app.distributedlock.annotation.Lock;
import com.app.distributedlock.annotation.LockKey;
import com.app.distributedlock.lock.CLock;
...
public class DistributedLockAspect {
    ...
    @Autowired
    private CLock distributeLock;
    @Autowired
    private LockProperties lockProperties;

    @Pointcut("@annotation(com.app.distributedlock.annotation.Lock)")
    public void advice(){
    }
