...
$.fn.extend({
        Scroll:function(opt,callback){
                ...
                var timerID;
                var _this=$("#"+opt.ul);//需要滚动的ul

				var lineH = scroll_ul.find("li:first").height();
                ...
                var timer = opt.timer //?parseInt(opt.timer,10):3000; //滚动的时间间隔（毫秒＿
...
$(document).ready(function () {
	$("#HoverTreeScroll").Scroll({ line: 1, speed: 500, timer: 0, up: "but_up", down: "but_down" ,ul:"myul"});
});
**/